...
# Load YOLO
net = cv.dnn.readNet("D:/home/C3 PROJECT/yolov3.weights", "D:/home/C3 PROJECT/yolov3.cfg")
...
while True:
    ...
    if elapsed_time >= timeout:
        print("No detection in 10 seconds. Exiting...")
        break
    ...
    # If any object is detected, reset the timer
    if len(boxes) > 0:
        start_time = time.time()
