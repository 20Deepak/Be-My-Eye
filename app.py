...
def voice_command():
    ...
    try:
        ...
        if text.lower() == "talk":
            ...
            show_object_screen()
        elif text.lower() == "money":
            show_currency_screen()
...
def show_home_screen():
    mic_img = PhotoImage(file="D:/home/C3 PROJECT/mic.png")
...
# Create OCR screen
def show_ocr_screen():
    subprocess.call(["python", "ocr.py"], cwd="D:/home/C3 PROJECT")  
    print("Reading....")

# Create a text to speech screen
def show_text_screen():
    subprocess.call(["python", "pdf_reader.py"], cwd="D:/home/C3 PROJECT")  
    print("TTS....")

# Create a object screen
def show_object_screen():
    subprocess.call(["python", "object detection.py"], cwd="D:/home/C3 PROJECT")  
    print("Object Detection....")

def show_currency_screen():
    subprocess.call(["python", "currency.py"], cwd="D:/home/C3 PROJECT")  
